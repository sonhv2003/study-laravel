...
class cls_mysql
{
    ...
    function query($sql, $type = '')
    {
        ...
        /** Dành cho những query ko phải Ajax */
        if (!($query = mysqli_query($this->link_id, $sql)) && $type != 'SILENT')
        {
            ...
            throw new Exception("MySQL Query Error : ".mysqli_error($this->link_id).$sql, 1);
            return false;
        }
        /** Ghi log câu lệnh SQL Query Ajax để Debug khi MODE = 8 */
    ...
    {
        $str = "Message: ".$this->error_message[0]['message'];
        $str .= "- Error: ".$this->error_message[2]['error'];
        $str .= "- SQL: ".$this->error_message[1]['sql'];
