...
/**
 * Lấy tin liên quan cho danh mục, bài viết
 *
 * @access  public
 * @param   integer $goods_id
 * @return  array
 */
function get_articles_relate($module_id, $module = 'category')
{
    $sql = "SELECT g.article_id, a.title, g.sort " .
            " FROM " .$GLOBALS['ecs']->table('article_relate') . " AS g, " .
                $GLOBALS['ecs']->table('article') . " AS a " .
            " WHERE g.module_id = '$module_id' " .
            " AND g.article_id = a.article_id AND g.module = '$module' ";
    if ($module_id == 0)
    {
 ...
 * @access  public
 * @param   integer $goods_id
 * @param   integer $module 0:goods | 1:article
 * @return  array
 */
function get_linked_goods($goods_id, $module = 0)
{
    ...
    $sql .= $module == 0 ? " AND lg.module = 0 " : " AND lg.module = 1";
