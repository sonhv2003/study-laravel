...
// $modules['02_cat_and_goods']['08_attribute_seo']    = 'attribute_seo.php?act=list';
...
//$modules['02_cat_and_goods']['category_price']             = 'category_price.php?act=list';
...
//$modules['07_content']['software']                 = 'software.php?act=list';
$modules['07_content']['tags']                 = 'tags.php?act=list';
