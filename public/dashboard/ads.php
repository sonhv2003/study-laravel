...
elseif ($_REQUEST['act'] == 'add')
{
    ...
    $smarty->assign('ads',
        array('ad_link' => $ad_link, 'ad_name' => $ad_name, 'start_time' => $start_time,
            'end_time' => $end_time, 'enabled' => 1, 'ad_sort' => 1, 'lazyload'=>0));
...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $lazyload    = !empty($_POST['lazyload'])    ? intval($_POST['lazyload'])  : 0;
    ...
    /* 插入数据 */
    $sql = "INSERT INTO ".$ecs->table('ad'). " (position_id,media_type,ad_name,ad_link,ad_code,ad_sort,start_time,end_time,link_man,link_email,link_phone,click_count,enabled,lazyload)
