...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $attr = array(
        ...
        'attr_name_custom' => $_POST['attr_name_custom'],
        ...
        'extra_type'     => isset($_POST['extra_type']) ? $_POST['extra_type'] : 'default',
        'attr_link'       => isset($_POST['attr_link']) ? $_POST['attr_link'] : '',
        'attr_compare'    => empty($_POST['attr_compare']) ? 0 : 1,
    );

    /* chỉ tạo slug cho thuộc tính lọc */
    if($attr['attr_type']){
        $final_name = !empty($attr['attr_name_custom']) ? $attr['attr_name_custom'] : $attr['attr_name'];
        $attr['slug'] = empty($_POST['slug']) ? build_slug($final_name) : $_POST['slug'];
    }
