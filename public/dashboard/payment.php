...
elseif (isset($_POST['Submit']))
{
    ...
    if ($_POST['pay_id'])
    {
        ...
        $sql = "UPDATE " . $ecs->table('payment') .
               ...
               "    pay_limit_code = '$_POST[pay_limit_code]'," .
    ...
    else
    {
        ...
        else
        {
            ...
            $sql = "INSERT INTO " . $ecs->table('payment') . " (pay_code, pay_name, pay_desc, pay_limit_code, pay_config, is_cod, pay_fee, enabled, is_online)" .
                   "VALUES ('$_POST[pay_code]', '$_POST[pay_name]', '$_POST[pay_desc]', '$_POST[pay_limit_code]', '$pay_config', '$_POST[is_cod]', '$pay_fee', 1, '$_POST[is_online]')";
            $db->query($sql);
        }
